      ...
      <TableContainer sx={tableStyles.container}>
        <Table> 
          <TableHead sx={tableStyles.head}>
            <TableRow>
              <TableCell sx={{ ...tableStyles.cell, width: '3%', pl: 5 }}><Typography sx={tableStyles.typography}>Status</Typography></TableCell>
              ...
              businessProfiles
                ...
                .map((profile) => (
                  <TableRow
                    ...
                    <TableCell sx={{ ...tableStyles.cell, pl: 5 }}>Pending</TableCell>
                    ...
                    <TableCell sx={tableStyles.cell}>
                      <Box>
                        {profile.status === "Pending" && (
                          <Button variant="contained" sx={tableStyles.deleteButton}>Cancel</Button>
                        )}
